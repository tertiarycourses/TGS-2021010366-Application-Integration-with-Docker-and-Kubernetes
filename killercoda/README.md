...
?? **https://killercoda.com/tertiary-labs/course/killercoda**

Click the link, select your lab, click **Start** ? a live terminal opens in your browser.
...
```
**Fix:** Remove the `!` from the command:
```bash
# This will fail
